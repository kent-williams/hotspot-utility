 ...
 **/
@interface ProtosHotspotutilityRoot : GPBRootObject
@end
...
@interface Protoswifi_services_v1 : GPBMessage
...
@interface Protoswifi_connect_v1 : GPBMessage
...
@interface Protoswifi_remove_v1 : GPBMessage
